...
const styles = StyleSheet.create({
  card: { width: '100%', backgroundColor: Colors.paper, borderRadius: 22, overflow: 'hidden', borderWidth: 1, borderColor: Colors.line, minWidth: 0, flex: 1, ...Shadows.card },
  imageWrap: { height: 210, position: 'relative', backgroundColor: Colors.coralSoft },
  image: { width: '100%', height: '100%' },
  badge: { position: 'absolute', left: 14, top: 14, maxWidth: '70%', borderRadius: 20, paddingHorizontal: 11, paddingVertical: 7 },
  ...
  content: { padding: 18 },
  metaRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 6, marginBottom: 8 },
  category: { flexShrink: 1, color: Colors.coralDark, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.8 },
  location: { flexShrink: 1, color: Colors.muted, fontSize: 12 },
  ...
  receivedRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 6, backgroundColor: Colors.primarySoft, borderRadius: 10, paddingHorizontal: 11, paddingVertical: 9, marginTop: 12 },
  ...
  verifiedRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 6, marginTop: 14 },
  ...
  progressMeta: { flexDirection: 'row', justifyContent: 'space-between', flexWrap: 'wrap', gap: 6, marginTop: 8 },
